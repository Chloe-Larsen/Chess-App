...
## Features
 ...
 - **Turn Management:** Visual Indicator showing which turn it is
 - **Legal Move Highlighted:** All legal moves for a tile are indicated with green tiles for the selected tile
...
## Installation
1. Clone the repo:
[git] (https://github.com/Chloe-Larsen/Chess-App)
...
2. **Selecting a piece:** Click on any of your pieces (highlighted with your color). Valid moves will be highlighted in green.
...
- **Pawn Promotion:** Pawns reaching the opposite end of the board will be promoted